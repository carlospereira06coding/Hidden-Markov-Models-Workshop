# Research Workshop: Hidden Markov Models for drug design ( prediciton of transmembrane proteins topology )

Welcome! This workshop was developed by 4 bioinformatics students from the 2nd year of the Bachelor's in Bioinformatics at FCUP, University of Porto.
...
## Goal Objective : Precition of the extracellular domain of CCR5 HIV co-receptor
...
## Metodology and Implementations
...
With the results of this prediction, we identified correctly the binding site of HIV in this protein, and the next step is to develop the drug that will bind here and block the entrance of HIV into the immune system. This results can be found in the last slide of our presentation.
